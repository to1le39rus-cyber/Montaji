...
function ensureHeader() {
  ...
  greeting.innerHTML = `${avatarMarkup(name)}<div class="profile-copy"><div class="profile-hello">Привет, ${escapeHtml(name)}! 👋</div><div class="profile-sub">${escapeHtml(dateLabel())} · Монтажник</div></div>`;
