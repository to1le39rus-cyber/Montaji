function patchDaySheetSource(source){
  ...
  const fn=`function openDay(d){
    ...
    m.querySelector('#dayIncome').onclick=()=>{m.remove();globalThis.__montajiQuickIncome?.(d)};
