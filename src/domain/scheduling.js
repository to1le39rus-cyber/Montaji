...
export const sortBySchedule = jobs => [...(Array.isArray(jobs)?jobs:[])].sort((a,b)=>String(a?.slot||'').localeCompare(String(b?.slot||''), 'ru', {numeric:true}) || String(a?.time||'').localeCompare(String(b?.time||'')));
