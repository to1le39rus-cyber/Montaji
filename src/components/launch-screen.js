...
export const createLaunchScreen=({mount=document.body}={})=>{
 ...
 screen.innerHTML='<div class="launch-aurora" aria-hidden="true"></div><div class="launch-grain" aria-hidden="true"></div><div class="launch-stage"><div class="launch-mark" aria-hidden="true">'+montraMark({className:'launch-montra-mark'})+'<i></i></div><div class="launch-word"><strong>MONTRA</strong></div><p>Партнёрство в работе</p></div><div class="launch-system"><div class="launch-status"><i></i><span>Запускаем приложение</span></div><div class="launch-progress" aria-hidden="true"><i></i></div></div>';
