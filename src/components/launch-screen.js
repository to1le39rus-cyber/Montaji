...
export const createLaunchScreen=({mount=document.body}={})=>{
 ...
 screen.innerHTML='<div class="launch-aurora" aria-hidden="true"></div><div class="launch-grain" aria-hidden="true"></div><div class="launch-stage"><div class="launch-mark" aria-hidden="true"><svg viewBox="0 0 64 64"><path class="launch-frame" d="M13 50V14l19 17 19-17v36"/><path class="launch-core" d="M13 14h38M32 31v19"/></svg><i></i></div><div class="launch-word"><strong>МОНТАЖИ</strong><span>AA</span></div><p>Рабочее пространство</p></div><div class="launch-system"><div class="launch-status"><i></i><span>Запускаем приложение</span></div><div class="launch-progress" aria-hidden="true"><i></i></div></div>';
