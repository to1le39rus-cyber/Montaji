const APP_URL = new URL('app.js?runtime=20260903-stable-3', location.href);
...
async function boot(){
  ...
  try {
    await import(url);
    const notesUrl = new URL('notes-ui.js?v=20260903-1', location.href);
    await import(notesUrl.href);
