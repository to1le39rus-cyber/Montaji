// Firebase Web App configuration for the shared Montaji AA database.
// These values identify the Firebase project; Firebase Web config keys are not server secrets.
